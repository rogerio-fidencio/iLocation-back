...
public class OrderController {
	...
	@PatchMapping("/assign")
	public ResponseEntity<?> assignDeliveryPerson(@RequestBody DeliveryPersonAssignmentDTO dpaDTO){
		return service.assignDeliveryPerson(dpaDTO.getOrderID(), dpaDTO.getDeliveryPersonID());
	}
}
